...
require (
	...
	golang.conradwood.net/go-easyops v0.1.18332
...
require (
	...
	golang.conradwood.net/apis/htmlserver v1.1.2309 // indirect
	golang.conradwood.net/apis/objectstore v1.1.2309 // indirect
	golang.conradwood.net/apis/promconfig v1.1.2309 // indirect
