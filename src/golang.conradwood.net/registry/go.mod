...
require (
	...
	golang.conradwood.net/go-easyops v0.1.17334
...
require (
	...
	golang.conradwood.net/apis/goeasyops v1.1.2289 // indirect
	golang.conradwood.net/apis/h2gproxy v1.1.2289 // indirect
	golang.conradwood.net/apis/htmlserver v1.1.2289 // indirect
	golang.conradwood.net/apis/objectstore v1.1.2289 // indirect
	golang.conradwood.net/apis/promconfig v1.1.2289 // indirect
